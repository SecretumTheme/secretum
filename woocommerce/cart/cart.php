							...
							<?php if (wc_coupons_enabled()) { ?>
								...
								<div class="coupon row">
									<div class="col-xs pr-2">
										<input type="text" name="coupon_code" class="input-text form-control w-100" id="coupon_code" value="" placeholder="<?php esc_attr_e('Coupon code', 'secretum'); ?>" />
									</div>
									<div class="col-xs">
										<input type="submit" class="button w-100" name="apply_coupon" value="<?php esc_attr_e('Apply coupon', 'secretum'); ?>" />
									</div>
								</div>
