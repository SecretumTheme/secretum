...
if (!function_exists('secretum_copyright_container')) {
	function secretum_copyright_container()
	{
		...
		return apply_filters('secretum_copyright_container', $container . $background . $border . $margin . $padding, 10, 1);
	}
}
...
if (!function_exists('secretum_copyright_text_alignment')) {
	...
	{
		return apply_filters('secretum_copyright_text_alignment', secretum_mod('copyright_text_alignment', 'attr', true), 10, 1);
	}
}
...
if (!function_exists('secretum_copyright_textuals')) {
	function secretum_copyright_textuals()
	{
		...
		return apply_filters('secretum_copyright_textuals', $textuals . $text_color . $link_colors, 10, 1);
	}
}
