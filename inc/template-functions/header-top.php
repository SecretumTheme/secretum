...
function secretum_header_top_wrapper() {
	...
	echo esc_html( apply_filters( 'secretum_header_top_wrapper', $background . $border . $margin . $padding, 10, 1 ) );
}
...
function secretum_header_top_container() {
	...
	echo esc_html( apply_filters( 'secretum_header_top_container', $container . $background . $border . $margin . $padding . $textuals . $text_color . $link_colors, 10, 1 ) );
}
