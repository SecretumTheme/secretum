...
$wp_customize->add_control('secretum[feature_documentation_display]', array(
	'label' 		=> __('Enable Documentation', 'secretum'),
    'description' 	=> __('Check to enable the custom post type documentation, with categories, tags and a custom template. Found under the Pages menu.', 'secretum'),
...
$wp_customize->add_control('secretum[feature_documentation_toc]', array(
...
$wp_customize->add_control('secretum[feature_documentation_category_widget]', array(
...
$wp_customize->add_control('secretum[feature_documentation_recent_widget]', array(
...
$wp_customize->add_control('secretum[feature_documentation_taxonomy_topic]', array(
...
$wp_customize->add_control('secretum[feature_documentation_taxonomy_tag]', array(
...
$wp_customize->add_control('secretum[documentation_container]', array(
...
$wp_customize->add_control('secretum[documentation_wrapper_padding]', array(
...
$wp_customize->add_control('secretum[documentation_container_padding]', array(
