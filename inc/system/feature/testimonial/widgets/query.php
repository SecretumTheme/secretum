 ...
 * Displays a select number of 'testimonial' posts
 *
 * @package WordPress
...
if(!class_exists('SecretumTestimonialQueryWidget'))
{
	class SecretumTestimonialQueryWidget extends WP_Widget
	{
		...
		function __construct()
		{
			parent::__construct(
				// Widget Base ID
				'secretum_testimonials_query_widget',

				// Widget Name
				__('Testimonial Query', 'secretum'),

				// Widget Options
				array(
					'description' 	=> __('Display one or more testimonials in a selected order.', 'secretum'),
		...
		public function form($instance)
		{
			...
			$title_value = !empty($title) ? esc_attr($title) : __('Testimonials', 'secretum');
