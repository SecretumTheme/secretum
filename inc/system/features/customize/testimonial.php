...
// Control :: Enable Testimonial
$wp_customize->add_control('secretum_feature_testimonial_display]', array(
	'label' 			=> __('Enable Testimonials', 'secretum'),
    'description' 		=> __('Check to enable the custom post type testimonial with widgets and shortcodes.', 'secretum'),
...
$wp_customize->add_control('secretum_feature_testimonial_query_widget]', array(
