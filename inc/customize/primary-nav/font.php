 ...
 * Section :: Menu Items
 */
$wp_customize->add_section('secretum_primary_nav_font', array(
...
// Setting :: Font Family
$wp_customize->add_setting('secretum[primary_nav_font_family]' , array(
...
// Control :: Font Family
$wp_customize->add_control('secretum[primary_nav_font_family]', array(
	'label' 				=> __('Font Family', 'secretum'),
	'section' 				=> 'secretum_primary_nav_font',
	'type' 					=> 'select',
...
// Setting :: Font Style
$wp_customize->add_setting('secretum[primary_nav_font_style]' , array(
	'sanitize_callback' 	=> 'sanitize_key',
	'transport' 			=> 'refresh',
	'type' 					=> 'option',
	'default' 				=> ''
...
// Control :: Font Style
$wp_customize->add_control('secretum[primary_nav_font_style]', array(
...
$wp_customize->add_setting('secretum[primary_nav_text_transform]' , array(
	'sanitize_callback' 	=> 'sanitize_key',
	'transport' 			=> 'refresh',
	'type' 					=> 'option',
	'default' 				=> ''
...
$wp_customize->add_control('secretum[primary_nav_text_transform]', array(
