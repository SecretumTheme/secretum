...
function secretum_customizer_text_colors() {
	return [
		...
		'color-primary-dark'   => __( 'Primary Theme "Dark" Color', 'secretum' ),
		'color-primary-light'  => __( 'Primary Theme "Light" Color', 'secretum' ),
		'color-secondary-text' => __( 'Secondary Text Color', 'secretum' ),
		'color-secondary'      => __( 'Secondary Theme Color', 'secretum' ),
		'color-light'          => __( 'Light Color Base', 'secretum' ),
		'color-dark'           => __( 'Dark Color Base', 'secretum' ),
		'color-white'          => __( 'White', 'secretum' ),
		'color-whitish'        => __( 'Whitish', 'secretum' ),
...
function secretum_customizer_link_colors() {
	return [
		...
		'color-primary-text-link'   => __( 'Theme Text Color', 'secretum' ),
		'color-primary-link'        => __( 'Primary Theme Color', 'secretum' ),
		'color-primary-dark-link'   => __( 'Primary Theme "Dark" Color', 'secretum' ),
		'color-primary-light-link'  => __( 'Primary Theme "Light" Color', 'secretum' ),
		'color-secondary-text-link' => __( 'Secondary Text Color', 'secretum' ),
		'color-secondary-link'      => __( 'Secondary Theme Color', 'secretum' ),
		'color-light-link'          => __( 'Light Color Base', 'secretum' ),
		'color-dark-link'           => __( 'Dark Color Base', 'secretum' ),
		'color-white-link'          => __( 'White', 'secretum' ),
		'color-whitish-link'        => __( 'Whitish', 'secretum' ),
...
function secretum_customizer_link_hover_colors() {
	return [
		...
		'color-primary-dark-hover'   => __( 'Primary Theme "Dark" Color', 'secretum' ),
		'color-primary-light-hover'  => __( 'Primary Theme "Light" Color', 'secretum' ),
		'color-secondary-text-hover' => __( 'Secondary Text Color', 'secretum' ),
		'color-secondary-hover'      => __( 'Secondary Theme Color', 'secretum' ),
		'color-light-hover'          => __( 'Light Color Base', 'secretum' ),
		'color-dark-hover'           => __( 'Dark Color Base', 'secretum' ),
		'color-white-hover'          => __( 'White', 'secretum' ),
		'color-whitish-hover'        => __( 'Whitish', 'secretum' ),
...
function secretum_customizer_background_colors() {
	return [
		...
		'bg-primary-dark'  => __( 'Primary Theme "Dark" Color', 'secretum' ),
		'bg-primary-light' => __( 'Primary Theme "Light" Color', 'secretum' ),
...
function secretum_customizer_background_hover_colors() {
	return [
		...
		'bg-primary-dark-hover'  => __( 'Primary Theme "Dark" Color', 'secretum' ),
		'bg-primary-light-hover' => __( 'Primary Theme "Light" Color', 'secretum' ),
