...
if(!class_exists('SecretumCategoriesWidget'))
{
	class SecretumCategoriesWidget extends WP_Widget
	{
		...
		function __construct()
		{
			parent::__construct(
				// Widget Base ID
				'documentation_categories_widget',

				// Widget Name
				esc_html__('Documentation Categories', 'secretum'),

				// Widget Options
				array(
					'description' 	=> esc_html__('Display a list or dropdown menu of Documentation categories', 'secretum'),
			...
			$this->widget_title = esc_html__('Categories', 'secretum');
		}
