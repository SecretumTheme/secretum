...
Install the free [Secretum Updater Plugin](https://github.com/SecretumTheme/secretum-updater) to allow Secretum downloaded from Github to update like other themes.
...
2) Unzip the secretum-#.#.#.zip file and open, rename the (secretum-#.#.#) directory to 'secretum' (all lowercase), then re-zip the secretum directory naming the zip file secretum.zip
...
### 1.8.0
* Released: 2019-08-18
* Changelog: https://github.com/SecretumTheme/secretum/blob/master/CHANGELOG.md#0180
...
* [WordPress](https://www.wordpress.org/) and [WP CLI](https://wp-cli.org/)
...
* [WordPress Gulpfile](https://github.com/ChrisWinters/gulpfile)
* [WordPress Navwalker](https://github.com/wp-bootstrap/wp-bootstrap-navwalker)
