		...
		<?php if (is_single()) { ?>
			...
			<span class="posted-on">
				...
				<?php if (!secretum_mod('entrymeta_published_status')) { ?>
					...
					<?php if (secretum_mod('entrymeta_link', 'attr') == "month") { ?>
					...
					<?php } elseif (secretum_mod('entrymeta_link', 'attr') == "day") { ?>
					...
					<?php } elseif (secretum_mod('entrymeta_link', 'attr') == "post") { ?>
			...
			<?php if (!secretum_mod('entrymeta_author_status')) { ?>
				...
				<span class="byline">
					...
					<?php if (secretum_mod('entrymeta_author_link', 'attr') == 'author') { ?>
